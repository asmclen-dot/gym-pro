...
- Daily Data (calories are net calories, combining food intake and exercise):
  \`\`\`json
  {{{json dailyData}}}
  \`\`\`

Instructions:
1.  **Period Summary**: Calculate the average daily net calories. Summarize the user's overall performance in an encouraging tone.
...
4.  **Recommendations**: Provide 2-3 clear, actionable recommendations for the user to improve in the next period.
