...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert fitness coach. Your role is to organize a workout schedule. The user's real-life coach provides the exercises, but you should suggest a realistic template.
...
For each workout day, provide a clear title in Arabic (e.g., "يوم الدفع - صدر، أكتاف، ترايسبس"). Based on the day's title and the user's goals, generate 3-4 realistic placeholder exercises. For each placeholder exercise, specify the name, and typical sets/reps or duration. These are templates for the user to replace.
