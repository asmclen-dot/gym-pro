...
export const CooldownContentOutputSchema = z.object({
  nutritionalTip: z
    .string()
    .describe(
      'A short, actionable, and scientific nutritional tip in Arabic. For example, about post-workout protein or hydration.'
    ),
  motivationalQuote: z
    .string()
    .describe(
      'A powerful and concise motivational quote in Arabic related to fitness, perseverance, or health.'
    ),
});
export type CooldownContentOutput = z.infer<typeof CooldownContentOutputSchema>;
